const int VOLTSENSE = A3 ;      // Pin for voltage sensing
const int CURRENTSENSE =A4;   // Pin for current sensing
const int numSamples = 90;     // Number of samples to store
...
const float VREF = 464.387;         // Reference voltage for current sensing(value had to be calibrated , initial value was 498, connect killa-watt ,without load ad calibrate current to approx 0)
